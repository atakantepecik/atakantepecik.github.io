...
title: about
permalink: /
subtitle: <a href='https://www.fh-aachen.de/forschung/institute/ifb/'>FH Aachen University of Applied Sciences, Institute for Bioengineering</a>.
...
profile:
  ...
  more_info: >
    <p>tepecik@fh-aachen.de</p>
    <p>Heinrich Mußmann Straße 1</p>
    <p>Jülich 52428 Germany</p>
...
The AstroBioLab is a compact laboratory built to look for signs of life in water. Within the TRIPLE project I am responsible for its design, integration and scientific operation - deciding which measurements are worth carrying when mass, power and volume are all severely constrained. The difficult part is rarely detecting a signal. It is establishing that what you detected came from the environment and not from the instrument that went in with it.
